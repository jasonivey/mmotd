...
TEST_CASE("information ids are correct", "[InformationId]") {
    ...
    CHECK(InformationId::ID_PROCESSOR_COUNT_PROCESSOR_CORE_COUNT ==
    ...
    CHECK(InformationId::ID_PROCESSES_PROCESS_COUNT ==
    ...
    CHECK(InformationId::ID_SYSTEM_INFORMATION_BYTEORDER ==
